...
function testTweet(tweet){
  ...
  if(tweet.entities.hasOwnProperty('user_mentions')){
  ...
  if(tweet.hasOwnProperty('in_reply_to_status_id_str')){
  ...
  if(tweet.hasOwnProperty('is_quote_status')){
    expect(tweet.is_quote_status).toBe(true);
